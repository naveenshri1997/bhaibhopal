...
const ShowHero = () => {
    ...
    const columns = [
        ...
        {
            name: 'Action',
            cell: row => <><Link className='btn btn-primary' to={"/updatehero/" + row._id}>Edit
            </Link> &nbsp; &nbsp; &nbsp;
                <Link className='btn btn-danger' onClick={() => deletehero(row._id)}>Delete</Link></>
        }
    ];
    return (
        <>
                                ...
                                <div className="card-body">
                                    <form method='POST'>
                                        <div className="d-flex flex-column flex-md-row justify-content-between align-items-center">
                                            <div className="fs-4 text-secondary fw-bolder">View Hero</div>
