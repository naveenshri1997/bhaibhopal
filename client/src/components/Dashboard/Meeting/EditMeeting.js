...
const EditMeeting = () => {
    ...
    const updatemeeting = async (e) => {
        ...
        if (res.status === 400 || !data) {
            window.alert("Meeting Not Updated");
        } else {
            history('/showmeeting');
                                ...
                                <div className="card-body">
                                    <form method='POST' encType='multipart/form-data'>
                                        <div className="d-flex flex-column flex-md-row justify-content-between align-items-center">
                                            <div className="fs-4 text-secondary fw-bolder">Update Meeting</div>
                                        ...
                                        <div className="mb-3 row">
                                            ...
                                            <div className="col-sm-9">
                                                <input type="submit" value='Update Meeting' onClick={updatemeeting} className="btn pt-2 pb-2 px-5 bg-secondary bg-gradient text-dark bg-opacity-50" />
                                            </div>
                                        </div>
                                    </form>
                                    <hr />
