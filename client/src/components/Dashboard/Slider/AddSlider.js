                                ...
                                <div className="card-body">
                                    <form method='POST' encType='multipart/form-data'>
                                        <div className="d-flex flex-column flex-md-row justify-content-between align-items-center">
                                            <div className="fs-4 text-secondary fw-bolder">Add Slider</div>
                                        ...
                                        <div className="mb-3 row">
                                            ...
                                            <div className="col-sm-9">
                                                <input type="submit" onClick={addslider} value="Add Slider" className="btn pt-2 pb-2 px-5 bg-secondary bg-gradient text-dark bg-opacity-50" />
                                            </div>
                                        </div>
                                    </form>
                                    <hr />
